...
public class CallerFragment extends BaseFragment {
  ...
  //  @Bind(R.id.open_fragment)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        openFragmentBtn = (Button) view.findViewById(R.id.open_fragment);
        pickPhoto = (Button) view.findViewById(R.id.pick_photo);
        picFile = (Button) view.findViewById(R.id.pick_doc);
        ...
        pickPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CallerFragmentPermissionsDispatcher.onPickPhotoWithCheck(n);
            }
        });
        picFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the Signup activity
                CallerFragmentPermissionsDispatcher.onPickDocWithCheck(n);
            }
        });
